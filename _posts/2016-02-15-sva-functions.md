...
и других видов аудиторских процедур, таких как проектный аудит,
...
Подсистема контроля и управления обеспечивает формирование и контроль внутреннего  документооборота службы внутреннего аудита, включая обмен информацией ограниченного доступа, которая не должна попадать в общую внутрикорпоративную систему электронного документооборота. Все документы подсистемы хранятся в защищенном хранилище {{ sva }}, предназначенном для работы с конфиденциальной информацией.
