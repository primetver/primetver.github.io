...
Помимо аудиторских проверок предусматривается воможность автоматизации
...
Подсистема контроля и управления обеспечивает формирование, обеспечение и контроль внутреннего  документооборота службы внутреннего аудита, включая обмен информацией ограниченного доступа, которая не должна попадать в общую внутрикорпоративную систему электронного документооборота. Все документы подсистемы хранятся в защищенном хранилище документов {{ sva }}, предназначенном для работы с конфиденциальной информации.
...
Важнейшей функцией является сквозной контроль занятости сотрудников ДВА при исполнении поручений, а также участии в проверках с возможностью автоматизации выбора исполнителей для решения задач в зависимости от специализации, уровня квалификации и загруженности исполнителя. Подсистема обеспечивает построение отчетности по деятельностьи сотрудников по различным критериям, включая критерии эффективности использования рабочего времени, в случае если при внедрении {{ sva }} была включена функциональность учета рабоего времени.
...
Автоматизацию проведения аудиторских проверок обеспечивает подсистема поддержки проведения проверок. Основная деятельность по проведению проверки выполняются с применением автоматизированного рабочего места (АРМ) Аудитора, которое может быть реализовано как в стационарном, так и в мобильном исполнении.
